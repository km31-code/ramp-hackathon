    ...
    <article className="docs-sheet" id="docs">
      <header className="docs-hero">
        ...
        <p className="docs-lede">
          A projector-facing simulation of adaptive offense and defense. An AI attacker generates
          seven different ways to disguise a forbidden expense, learns from every denial, and tries
          again. If one slips through, Codex promotes that exact pattern into a validated policy
          signature. It never connects to a card, vendor, or purchasing tool.
        </p>
      </header>
